...
En el ordenador, necesitaremos un cliente FTP para conectarnos a la IP del PLC que se encuentra en nuestra misma red y descargaremos el fichero csv para su posterior estudio.
